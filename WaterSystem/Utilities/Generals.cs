...
namespace SAyCC.WaterSystem.Utilities
{
    ...
    public class Generals : IGenerals
    {
        ...
        private int idManzana => (int)_httpContextAccessor.HttpContext.Session.GetInt32(Sessions.IdManzana);
        ...
        public List<ModuleEntity> AllPagesByAppList
    {
        ...
        /// <summary>
        /// Regresa la validación si entre los roles que tiene, se encuentra algún rol en específico.
        /// </summary>
        ...
        /// <summary>
        /// Regresa la validación si entre las manzanas que tiene, se encuentra alguna manzana en específico.
        /// </summary>
        ...
        /// <summary>
        /// Regresa la manzana a la que pertenece el usuario.
        /// </summary>
        public int IdManzana { get { return idManzana; } }
